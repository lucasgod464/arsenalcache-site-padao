    ...
    <section id="precos" className="py-20 px-4 bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto lg:hidden">
          {/* Plan 1 */}
          <div 
            className={`pricing-card rounded-xl p-6 bg-white border shadow-lg transition-all duration-300 hover:shadow-xl relative ${selectedPlan === 1 ? 'ring-2 ring-blue-500' : ''}`} 
          ...
          {/* Plan 2 */}
          <div 
            className={`pricing-card rounded-xl p-6 bg-white border shadow-lg transition-all duration-300 hover:shadow-xl relative overflow-hidden ${selectedPlan === 2 ? 'ring-2 ring-green-500' : ''}`} 
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-200 shadow-lg bg-white">
            <Table>
                ...
                <TableRow className="bg-gradient-to-r from-blue-50 to-green-50">
                  ...
                  <TableHead className="w-1/3 p-6 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      <button 
                        ...
                        className="mt-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-full px-6 py-3 text-sm font-medium transition-all hover:shadow-lg hover:shadow-blue-500/20 active:scale-[0.98]"
                      >
                        Escolher este plano
                      </button>
                    </div>
                  ...
                  <TableHead className="w-1/3 p-6 text-center relative">
                    ...
                    <div className="absolute -right-8 -top-8 transform rotate-45">
                      <div className="bg-amber-500 text-white text-xs font-bold py-1 px-12 shadow-md">
                        POPULAR
                      </div>
                    </div>
                    <div className="flex flex-col items-center relative">
                      ...
                      <button 
                        onClick={() => scrollToSection('contato')} 
                        className="mt-3 bg-gradient-to-r from-green-500 to-green-700 text-white rounded-full px-6 py-3 text-sm font-medium transition-all hover:shadow-lg hover:shadow-green-500/20 active:scale-[0.98]"
                      >
                        Escolher este plano
                      </button>
                    </div>
              ...
              <TableBody>
                ...
                {planFeatures.plan2Additional.map((feature, index) => (
                  <TableRow key={`p2-${index}`} className={planFeatures.common.length + index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                    <TableCell className="p-4 font-medium">{feature}</TableCell>
                    <TableCell className="p-4 text-center">
        ...
        <div className="text-center mt-16 max-w-3xl mx-auto fade-in-section">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <button 
              onClick={() => scrollToSection('contato')} 
              className="inline-flex items-center bg-gradient-to-r from-blue-600 to-blue-800 text-white font-medium rounded-full px-8 py-3 hover:shadow-lg hover:shadow-blue-500/20 transition-all active:scale-[0.98]"
            >
