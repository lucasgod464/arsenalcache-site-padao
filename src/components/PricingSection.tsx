      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-md mx-auto relative">
          <div className="absolute -top-4 -right-4 z-10 rotate-12">
            <div className="bg-gradient-to-r from-purple-500 to-blue-600 text-white text-xs font-bold px-6 py-1 rounded-full shadow-lg flex items-center gap-1">
          ...
          <Card className="h-full transition-all duration-300 overflow-hidden bg-white border-gray-200 hover:shadow-md ring-2 ring-blue-500 shadow-xl shadow-blue-200">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 pb-6 border-b border-gray-100">
              <div className="space-y-1.5">
                <Badge className="bg-purple-100 text-purple-700 border-0 mb-2 font-medium">
                  White Label Premium
                </Badge>
              ...
              <div className="mt-4 flex items-baseline justify-center">
                <span className="text-4xl font-extrabold tracking-tight text-purple-700">R$698,80</span>
            ...
            <CardContent className="pt-6">
              <div className="space-y-5">
                <div>
                  <h4 className="font-semibold mb-3 text-purple-600 flex items-center">
                    <Trophy className="h-5 w-5 text-purple-500 mr-2" />
                    Recursos principais:
                  </h4>
                  <ul className="space-y-2.5 border-l-2 border-purple-100 pl-3">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-purple-600">Softwares premium inclusos:</h4>
                  <ul className="space-y-2.5 border-l-2 border-purple-100 pl-3">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-purple-600">Conexões adicionais (opcionais):</h4>
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg border border-purple-100">
                    ...
                    <div className="bg-white p-3 rounded-lg border border-gray-200 text-center shadow-sm">
                      ...
                      <p className="text-2xl font-bold text-purple-600">R$260,00</p>
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-purple-600">Renovação anual:</h4>
                  <ul className="space-y-2.5 border-l-2 border-purple-100 pl-3">
            ...
            <CardFooter className="pt-4 pb-8 flex justify-center">
              <Button 
                asChild
                className="w-full bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white font-medium py-6 rounded-full transition-all shadow-md hover:shadow-lg"
              >
                <a 
