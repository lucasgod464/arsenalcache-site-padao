...
const PricingSection = () => {
  ...
  return <section id="precos" className="py-20 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Plan 1 */}
          <div className={`pricing-card fade-in-section ${selectedPlan === 1 ? 'ring-2 ring-blue-500' : ''}`} onClick={() => setSelectedPlan(1)}>
            <div className="mb-6">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {planFeatures.common.map((feature, index) => <li key={index} className="flex items-center gap-2">
          ...
          {/* Plan 2 */}
          <div className={`pricing-card fade-in-section ${selectedPlan === 2 ? 'ring-2 ring-green-500' : ''}`} onClick={() => setSelectedPlan(2)}>
            <div className="mb-6">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {planFeatures.plan2Additional.map((feature, index) => <li key={index} className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-green-500 flex-shrink-0" />
                    <span>{feature}</span>
                  </li>)}
