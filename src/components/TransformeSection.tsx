      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Veja como a inteligência artificial pode revolucionar 
            ...
            <div>
              ...
              <div className="mt-6">
                <Button 
                  ...
                  asChild
                >
                  <a href="/ia-conecta">Conheça nossa solução de IA</a>
                </Button>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg">
                ...
                <p className="italic mb-4">
                  "Implementamos a solução de IA e reduzimos nosso tempo de resposta em 85%. 
