    ...
    <section id="precos" className="py-20 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Plan 1 */}
          <div 
            className={`pricing-card fade-in-section ${selectedPlan === 1 ? 'ring-2 ring-arsenal-DEFAULT' : ''}`}
            onMouseEnter={() => setSelectedPlan(1)}
          >
            <div className="mb-6">
              <span className="inline-block py-1 px-3 rounded-full bg-arsenal-light/20 text-arsenal-dark text-sm font-medium mb-2">
                White Label Básico
              </span>
              ...
              <button 
                ...
                className="w-full btn-primary my-6"
              >
                Escolher este plano
              </button>
            </div>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-arsenal-dark">O que está incluído:</h4>
          ...
          {/* Plan 2 */}
          <div 
            className={`pricing-card fade-in-section ${selectedPlan === 2 ? 'ring-2 ring-arsenal-DEFAULT' : ''}`}
            onMouseEnter={() => setSelectedPlan(2)}
          >
            <div className="mb-6">
              <span className="inline-block py-1 px-3 rounded-full bg-whatsapp-light/20 text-whatsapp-dark text-sm font-medium mb-2">
                White Label Premium
              </span>
              ...
              <button 
                onClick={() => scrollToSection('contato')}
                className="w-full btn-accent my-6"
              >
                Escolher este plano
              </button>
            </div>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-arsenal-dark">Tudo do plano básico mais:</h4>
              <ul className="space-y-3">
                ...
                <li className="pt-4 border-t border-gray-100">
                  <h4 className="font-semibold mb-4 text-arsenal-dark">Conexões adicionais (opcional):</h4>
                </li>
                ...
                <li className="flex items-center gap-2">
                  <span className="text-sm text-gray-600">R$260,00/mês - Sem taxa de renovação mantendo a assinatura mensal</span>
                </li>
              </ul>
            </div>
          </div>
